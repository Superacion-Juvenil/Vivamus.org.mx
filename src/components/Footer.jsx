      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://www.facebook.com/VivamusMTY"
              target="_blank" rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-8 h-8 rounded-lg border border-white/15 flex items-center justify-center text-white/50 hover:text-white hover:border-white/40 transition-colors"
            >
            ...
            <a
              href="https://www.instagram.com/vivamus_mty"
              target="_blank" rel="noopener noreferrer"
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-white/40 text-xs">
            ...
            <span className="text-white/60 font-semibold">Superación Juvenil ABP</span>
          </p>
        </div>
      </div>
    </footer>
